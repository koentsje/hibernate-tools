...
/**
 * Tests for DynamicEntityBuilderPOC demonstrating how to build
 * entity metadata from database tables using Hibernate Models API.
 *
 * @author Koen Aers
 */
public class DynamicEntityBuilderPOCTest {

	@Test
	public void testCreateSimpleEntity() {
		// GIVEN: Database table metadata for a PERSON table
		DynamicEntityBuilderPOC.TableMetadata tableMetadata =
			new DynamicEntityBuilderPOC.TableMetadata("PERSON", "Person", "com.example.entity");
		tableMetadata.setSchema("public");

		tableMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("ID", "id", Long.class)
				.primaryKey(true)
				.autoIncrement(true)
		);

		tableMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("NAME", "name", String.class)
				.length(255)
				.nullable(false)
		);

		tableMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("EMAIL", "email", String.class)
				.length(100)
		);

		// WHEN: Building the entity using Hibernate Models
		DynamicEntityBuilderPOC builder = new DynamicEntityBuilderPOC();
	...
	public void testCreateEntityWithDifferentDataTypes() {
		...
		DynamicEntityBuilderPOC.TableMetadata tableMetadata =
			new DynamicEntityBuilderPOC.TableMetadata("PRODUCT", "Product", "com.example.entity");
		...
		tableMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("PRICE", "price", BigDecimal.class)
				.precision(10)
				.scale(2)
		);

		tableMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("QUANTITY", "quantity", Integer.class)
		);

		tableMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("ACTIVE", "active", Boolean.class)
		);
	...
	public void testEntityMetadataCanBeUsedForCodeGeneration() {
		...
		DynamicEntityBuilderPOC.TableMetadata tableMetadata =
			new DynamicEntityBuilderPOC.TableMetadata("USER_TABLE", "User", "com.example.entity");

		tableMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("USER_ID", "userId", Long.class)
				.primaryKey(true)
		);

		tableMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("USERNAME", "username", String.class)
				.length(50)
				.nullable(false)
		);
	...
	public void testCreateEntityWithManyToOneRelationship() {
		...
		DynamicEntityBuilderPOC.TableMetadata departmentMetadata =
			new DynamicEntityBuilderPOC.TableMetadata("DEPARTMENT", "Department", "com.example.entity");

		departmentMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("DEPT_ID", "deptId", Long.class)
				.primaryKey(true)
				.autoIncrement(true)
		);

		departmentMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("DEPT_NAME", "deptName", String.class)
				.length(100)
				.nullable(false)
		);
		...
		DynamicEntityBuilderPOC.TableMetadata employeeMetadata =
			new DynamicEntityBuilderPOC.TableMetadata("EMPLOYEE", "Employee", "com.example.entity");

		employeeMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("EMP_ID", "empId", Long.class)
				.primaryKey(true)
				.autoIncrement(true)
		);

		employeeMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("EMP_NAME", "empName", String.class)
				.length(200)
		);
		...
		employeeMetadata.addForeignKey(
			new DynamicEntityBuilderPOC.ForeignKeyMetadata(
	...
	public void testManyToOneCodeGeneration() {
		...
		employeeMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("DEPARTMENT_ID", "departmentId", Long.class)
		);
		employeeMetadata.addForeignKey(
			new DynamicEntityBuilderPOC.ForeignKeyMetadata(
	...
	public void testCreateEntityWithOneToManyRelationship() {
		...
		departmentMetadata.addOneToMany(
			new DynamicEntityBuilderPOC.OneToManyMetadata(
	...
	public void testCreateEntityWithOneToOneOwningAndInverse() {
		...
		DynamicEntityBuilderPOC.TableMetadata userMetadata =
			new DynamicEntityBuilderPOC.TableMetadata("USER_TABLE", "User", "com.example.entity");
		...
		userMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("ADDRESS_ID", "addressId", Long.class)
		);

		// OneToOne owning side: User -> Address via ADDRESS_ID
		userMetadata.addOneToOne(
			new DynamicEntityBuilderPOC.OneToOneMetadata(
		...
		DynamicEntityBuilderPOC.TableMetadata addressMetadata =
			new DynamicEntityBuilderPOC.TableMetadata("ADDRESS", "Address", "com.example.entity");
		...
		addressMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("STREET", "street", String.class)
				.length(255)
		);

		addressMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("CITY", "city", String.class)
				.length(100)
		);
	...
	public void testBidirectionalOneToOneCodeGeneration() {
		...
		userMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("USERNAME", "username", String.class).length(100)
		);
		userMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("ADDRESS_ID", "addressId", Long.class)
		);
		userMetadata.addOneToOne(
			new DynamicEntityBuilderPOC.OneToOneMetadata("address", "Address", "com.example.entity")
				.foreignKeyColumnName("ADDRESS_ID")
				.fetchType(FetchType.LAZY)
				.cascade(CascadeType.ALL)
				.optional(false)
		...
		addressMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("STREET", "street", String.class).length(255)
		);
		addressMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("CITY", "city", String.class).length(100)
		);
		addressMetadata.addOneToOne(
			new DynamicEntityBuilderPOC.OneToOneMetadata("user", "User", "com.example.entity")
				.mappedBy("address")
				.fetchType(FetchType.LAZY)
		);
		ClassDetails addressEntity = builder.createEntityFromTable(addressMetadata);
	...
	public void testCreateEntityWithManyToManyOwningAndInverse() {
		...
		DynamicEntityBuilderPOC.TableMetadata studentMetadata =
			new DynamicEntityBuilderPOC.TableMetadata("STUDENT", "Student", "com.example.entity");
		...
		studentMetadata.addManyToMany(
			new DynamicEntityBuilderPOC.ManyToManyMetadata(
		...
		DynamicEntityBuilderPOC.TableMetadata courseMetadata =
			new DynamicEntityBuilderPOC.TableMetadata("COURSE", "Course", "com.example.entity");
		...
		courseMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("TITLE", "title", String.class)
				.length(200)
		);
	...
	public void testBidirectionalManyToManyCodeGeneration() {
		...
		studentMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("NAME", "name", String.class).length(100)
		);
		studentMetadata.addManyToMany(
			new DynamicEntityBuilderPOC.ManyToManyMetadata("courses", "Course", "com.example.entity")
				.joinTable("STUDENT_COURSE", "STUDENT_ID", "COURSE_ID")
				.cascade(CascadeType.PERSIST, CascadeType.MERGE)
		);
		ClassDetails studentEntity = builder.createEntityFromTable(studentMetadata);
		...
		courseMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("TITLE", "title", String.class).length(200)
		);
		courseMetadata.addManyToMany(
			new DynamicEntityBuilderPOC.ManyToManyMetadata("students", "Student", "com.example.entity")
				.mappedBy("courses")
		);
		ClassDetails courseEntity = builder.createEntityFromTable(courseMetadata);
	...
	public void testCreateEntityWithEmbeddedAndEmbeddable() {
		...
		DynamicEntityBuilderPOC.EmbeddableMetadata addressEmbeddable =
			new DynamicEntityBuilderPOC.EmbeddableMetadata("Address", "com.example.entity");
		...
		addressEmbeddable.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("ZIP_CODE", "zipCode", String.class)
				.length(20)
		);

		// Build the embeddable
		ClassDetails addressClass = builder.createEmbeddable(addressEmbeddable);
		...
		DynamicEntityBuilderPOC.TableMetadata personMetadata =
			new DynamicEntityBuilderPOC.TableMetadata("PERSON", "Person", "com.example.entity");
		...
		personMetadata.addEmbeddedField(
			new DynamicEntityBuilderPOC.EmbeddedFieldMetadata(
	...
	public void testCreateEntityWithSingleTableInheritance() {
		...
		DynamicEntityBuilderPOC.TableMetadata vehicleMetadata =
			new DynamicEntityBuilderPOC.TableMetadata("VEHICLE", "Vehicle", "com.example.entity");
		...
		vehicleMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("MAKE", "make", String.class)
				.length(100)
		);

		vehicleMetadata
			.inheritance(
				new DynamicEntityBuilderPOC.InheritanceMetadata(InheritanceType.SINGLE_TABLE)
		...
		DynamicEntityBuilderPOC.TableMetadata carMetadata =
			new DynamicEntityBuilderPOC.TableMetadata("VEHICLE", "Car", "com.example.entity");

		carMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("NUM_DOORS", "numDoors", Integer.class)
		);
		...
		DynamicEntityBuilderPOC.TableMetadata truckMetadata =
			new DynamicEntityBuilderPOC.TableMetadata("VEHICLE", "Truck", "com.example.entity");

		truckMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("PAYLOAD_CAPACITY", "payloadCapacity", Double.class)
		);
	...
	public void testSingleTableInheritanceCodeGeneration() {
		...
		vehicleMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("MAKE", "make", String.class).length(100)
		);
		vehicleMetadata
			.inheritance(
				new DynamicEntityBuilderPOC.InheritanceMetadata(InheritanceType.SINGLE_TABLE)
	...
	public void testCreateEntityWithJoinedInheritance() {
		...
		DynamicEntityBuilderPOC.TableMetadata paymentMetadata =
			new DynamicEntityBuilderPOC.TableMetadata("PAYMENT", "Payment", "com.example.entity");
		...
		paymentMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("AMOUNT", "amount", java.math.BigDecimal.class)
				.precision(10).scale(2)
		);

		paymentMetadata
			.inheritance(new DynamicEntityBuilderPOC.InheritanceMetadata(InheritanceType.JOINED));
		...
		DynamicEntityBuilderPOC.TableMetadata ccPaymentMetadata =
			new DynamicEntityBuilderPOC.TableMetadata("CREDIT_CARD_PAYMENT", "CreditCardPayment", "com.example.entity");

		ccPaymentMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("CARD_NUMBER", "cardNumber", String.class)
				.length(19)
		);
	...
	public void testJoinedInheritanceCodeGeneration() {
		...
		DynamicEntityBuilderPOC.TableMetadata ccPaymentMetadata =
			new DynamicEntityBuilderPOC.TableMetadata("CREDIT_CARD_PAYMENT", "CreditCardPayment", "com.example.entity");
		ccPaymentMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("CARD_NUMBER", "cardNumber", String.class).length(19)
		);
		ccPaymentMetadata
			.parent("Payment", "com.example.entity")
			.primaryKeyJoinColumn("PAYMENT_ID");
		...
		DynamicEntityBuilderPOC.TableMetadata btPaymentMetadata =
			new DynamicEntityBuilderPOC.TableMetadata("BANK_TRANSFER_PAYMENT", "BankTransferPayment", "com.example.entity");
		btPaymentMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("BANK_NAME", "bankName", String.class).length(100)
		);
		btPaymentMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("ACCOUNT_NUMBER", "accountNumber", String.class).length(34)
		);
		btPaymentMetadata
			.parent("Payment", "com.example.entity");
	...
	public void testCreateEntityWithCompositeId() {
		...
		DynamicEntityBuilderPOC.EmbeddableMetadata idClassMetadata =
			new DynamicEntityBuilderPOC.EmbeddableMetadata("OrderItemId", "com.example.entity");

		idClassMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("ORDER_ID", "orderId", Long.class)
				.primaryKey(true)
		);

		idClassMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("PRODUCT_ID", "productId", Long.class)
				.primaryKey(true)
		);

		// Build the embeddable ID class
		ClassDetails idClass = builder.createEmbeddable(idClassMetadata);
		...
		DynamicEntityBuilderPOC.TableMetadata orderItemMetadata =
			new DynamicEntityBuilderPOC.TableMetadata("ORDER_ITEM", "OrderItem", "com.example.entity");
		...
		orderItemMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("UNIT_PRICE", "unitPrice", java.math.BigDecimal.class)
				.precision(10).scale(2)
		);

		// Configure composite ID
		orderItemMetadata.compositeId(
			new DynamicEntityBuilderPOC.CompositeIdMetadata(
	...
	public void testCompositeIdWithAttributeOverrides() {
		...
		DynamicEntityBuilderPOC.EmbeddableMetadata idClassMetadata =
			new DynamicEntityBuilderPOC.EmbeddableMetadata("FlightId", "com.example.entity");
		idClassMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("DEPARTURE", "departure", String.class).length(3)
		);
		idClassMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("ARRIVAL", "arrival", String.class).length(3)
		);
		builder.createEmbeddable(idClassMetadata);

		// Build entity with @EmbeddedId and attribute overrides
		DynamicEntityBuilderPOC.TableMetadata flightMetadata =
			new DynamicEntityBuilderPOC.TableMetadata("FLIGHT", "Flight", "com.example.entity");
		flightMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("FLIGHT_NUMBER", "flightNumber", String.class).length(10)
		);
	...
	public void testCreateEntityWithVersionField() {
		...
		DynamicEntityBuilderPOC.TableMetadata tableMetadata =
			new DynamicEntityBuilderPOC.TableMetadata("ARTICLE", "Article", "com.example.entity");
		...
		tableMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("CONTENT", "content", String.class)
		);

		tableMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("VERSION", "version", Integer.class)
				.version(true)
		);
	...
	public void testVersionFieldCodeGeneration() {
		...
		tableMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("VERSION", "version", Long.class)
				.version(true)
		);
		ClassDetails articleEntity = builder.createEntityFromTable(tableMetadata);
	...
	public void testCreateEntityWithBasicAndTemporal() {
		...
		DynamicEntityBuilderPOC.TableMetadata tableMetadata =
			new DynamicEntityBuilderPOC.TableMetadata("EVENT", "Event", "com.example.entity");
		...
		tableMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("DESCRIPTION", "description", String.class)
		...
		tableMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("STATUS", "status", String.class)
				.length(20)
				.basicOptional(false)
		);
		...
		tableMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("EVENT_DATE", "eventDate", java.util.Date.class)
				.temporal(TemporalType.DATE)
		);

		// Timestamp field with @Temporal(TIMESTAMP)
		tableMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("CREATED_AT", "createdAt", java.util.Date.class)
				.temporal(TemporalType.TIMESTAMP)
		);

		// Time field with @Temporal(TIME)
		tableMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("START_TIME", "startTime", java.util.Date.class)
	...
	public void testCreateEntityWithLobField() {
		...
		DynamicEntityBuilderPOC.TableMetadata tableMetadata =
			new DynamicEntityBuilderPOC.TableMetadata("DOCUMENT", "Document", "com.example.entity");
		...
		// BLOB field
		tableMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("ATTACHMENT", "attachment", byte[].class)
				.lob(true)
		);

		// LOB with @Basic(fetch = LAZY)
		tableMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("THUMBNAIL", "thumbnail", byte[].class)
				.lob(true)
				.basicFetch(FetchType.LAZY)
		);
	...
	public void testLobFieldCodeGeneration() {
		...
		tableMetadata.addColumn(
			new DynamicEntityBuilderPOC.ColumnMetadata("DATA", "data", byte[].class)
				.lob(true)
				.basicFetch(FetchType.LAZY)
		);
	 ...
	 */
	private String generateEntityCode(ClassDetails entity, DynamicEntityBuilderPOC builder) {
		StringBuilder code = new StringBuilder();
	 ...
	 */
	private String generateEmbeddableCode(ClassDetails embeddable, DynamicEntityBuilderPOC builder) {
		StringBuilder code = new StringBuilder();
