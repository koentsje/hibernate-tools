...
public class RevengStrategyWrapperFactoryTest {
	...
	public void testSetSettings() throws Exception {
		RevengSettingsWrapper revengSettingsWrapper = RevengSettingsWrapperFactory.createRevengSettingsWrapper((RevengStrategyWrapper) null);
