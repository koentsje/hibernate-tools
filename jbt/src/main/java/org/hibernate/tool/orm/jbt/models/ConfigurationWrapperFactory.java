...
public class ConfigurationWrapperFactory {
	...
	public static ConfigurationWrapper createNativeConfigurationWrapper() {
		return new ConfigurationWrapperImpl(new NativeConfiguration());
	}

	public static ConfigurationWrapper createRevengConfigurationWrapper() {
		return new ConfigurationWrapperImpl(new RevengConfiguration());
	}
	...
	public static class ConfigurationWrapperImpl implements ConfigurationWrapper {

		private Configuration wrappedConfiguration = null;
		private NamingStrategyWrapper namingStrategyWrapper = null;

		ConfigurationWrapperImpl(Configuration configuration) {
		...
		@Override public String getProperty(String property) { return wrappedConfiguration.getProperty(property); }
		@Override public ConfigurationWrapper addFile(File file) { wrappedConfiguration.addFile(file); return this; }
		@Override public void setProperty(String name, String value) { wrappedConfiguration.setProperty(name, value); }
		@Override public ConfigurationWrapper setProperties(Properties properties) { wrappedConfiguration.setProperties(properties); return this; }
		...
		public void setNamingStrategy(NamingStrategyWrapper namingStrategyWrapper) {
			if (wrappedConfiguration instanceof ExtendedConfiguration) {
				((ExtendedConfiguration) wrappedConfiguration).setNamingStrategy(
						(ImplicitNamingStrategy) namingStrategyWrapper.getWrappedObject());
			}
		}

		@Override public Properties getProperties() { return wrappedConfiguration.getProperties(); }
		@Override public void addProperties(Properties properties) { wrappedConfiguration.addProperties(properties); }
		...
		@Override public ConfigurationWrapper configure(File file) { wrappedConfiguration.configure(file); return this; }
		@Override public ConfigurationWrapper configure() { wrappedConfiguration.configure(); return this; }
		@Override public void addClass(Class<?> clazz) { wrappedConfiguration.addClass(clazz); }
		...
		public SessionFactoryWrapper buildSessionFactory() {
			return SessionFactoryWrapperFactory.createSessionFactoryWrapper(
					wrappedConfiguration.buildSessionFactory());
		}
		...
		public Iterator<PersistentClassWrapper> getClassMappings() {
			if (wrappedConfiguration instanceof ExtendedConfiguration) {
				Iterator<PersistentClass> classMappings =
						((ExtendedConfiguration) wrappedConfiguration).getClassMappings();
		...
		public void setReverseEngineeringStrategy(RevengStrategyWrapper strategy) {
			if (wrappedConfiguration instanceof ExtendedConfiguration) {
				((ExtendedConfiguration) wrappedConfiguration).setReverseEngineeringStrategy(
						(RevengStrategy) strategy.getWrappedObject());
			}
		}
		...
		public Iterator<TableWrapper> getTableMappings() {
			if (wrappedConfiguration instanceof ExtendedConfiguration) {
				Iterator<Table> tableMappings =
						((ExtendedConfiguration) wrappedConfiguration).getTableMappings();
