...
public class NamingStrategyWrapperFactory {
	...
	public static NamingStrategyWrapper createNamingStrategyWrapper(ImplicitNamingStrategy wrappedNamingStrategy) {
		return new NamingStrategyWrapperImpl(wrappedNamingStrategy);
	}

	public static class NamingStrategyWrapperImpl implements NamingStrategyWrapper {

		private ImplicitNamingStrategy namingStrategy = null;

		NamingStrategyWrapperImpl(ImplicitNamingStrategy namingStrategy) {
		...
		public String collectionTableName(
				String ownerEntity, String ownerEntityTable,
			...
			return namingStrategy.determineCollectionTableName(ictns).getText();
		}
		...
		public String columnName(String name) {
			...
			return namingStrategy.determineBasicColumnName(ibcns).getText();
		}
		...
		public String tableName(String name) {
			...
			return namingStrategy.determinePrimaryTableName(iens).getText();
		}
		...
		@Override
		public String joinKeyColumnName(String primaryKeyColumnName, String primaryTableName) {
			...
			return namingStrategy.determinePrimaryKeyJoinColumnName(ipkjcns).getText();
		}

		@Override
		public String getStrategyClassName() {
			return namingStrategy.getClass().getName();
		}
