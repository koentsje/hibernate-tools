...
public class ClassMetadataWrapperFactory {
	...
	public static class ClassMetadataWrapperImpl implements ClassMetadataWrapper {
		...
		ClassMetadataWrapperImpl(EntityPersister entityPersister) {
		...
		@Override public String getEntityName() { return wrappedClassMetadata.getEntityName(); }
		@Override public String getIdentifierPropertyName() { return wrappedClassMetadata.getIdentifierPropertyName(); }
		@Override public String[] getPropertyNames() { return wrappedClassMetadata.getPropertyNames(); }
		...
		@Override public Class<?> getMappedClass() { return wrappedClassMetadata.getMappedClass(); }
		...
		@Override public Object getPropertyValue(Object object, String name) { return wrappedClassMetadata.getPropertyValue(object, name); }
		@Override public boolean hasIdentifierProperty() { return wrappedClassMetadata.hasIdentifierProperty(); }
		...
		public boolean isInstanceOfAbstractEntityPersister() {
			return wrappedClassMetadata instanceof AbstractEntityPersister;
		}
