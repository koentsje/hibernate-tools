...
public class TypeWrapperFactory {
	...
	public static class TypeWrapperImpl implements TypeWrapper {

		private Type type = null;

		TypeWrapperImpl(Type type) {
			this.type = type;
		}
		...
		public String toString(Object object) {
			if (BasicType.class.isAssignableFrom(type.getClass())) {
				...
				throw new UnsupportedOperationException(
						"Class '" + type.getClass().getName() + "' does not support 'toString(Object)'.");
			}
		}
		...
		public Object fromStringValue(String stringValue) {
			if (BasicType.class.isAssignableFrom(type.getClass())) {
				...
				throw new UnsupportedOperationException(
						"Class '" + type.getClass().getName() + "' does not support 'fromStringValue(Object)'.");
			}
		}

		@Override public boolean isEntityType() { return type.isEntityType(); }
		...
		public boolean isOneToOne() {
			if (EntityType.class.isAssignableFrom(type.getClass())) {
				...
				throw new UnsupportedOperationException(
						"Class '" + type.getClass().getName() + "' does not support 'isOneToOne()'.");
			}
		}

		@Override public boolean isAnyType() { return type.isAnyType(); }
		@Override public boolean isComponentType() { return type.isComponentType(); }
		@Override public boolean isCollectionType() { return type.isCollectionType(); }
		...
		public Class<?> getPrimitiveClass() {
			if (!isInstanceOfPrimitiveType()) {
				throw new UnsupportedOperationException(
						"Class '" + type.getClass().getName() + "' does not support 'getPrimitiveClass()'.");
			}
		...
		public String getRole() {
			if (!isCollectionType()) {
				throw new UnsupportedOperationException(
						"Class '" + type.getClass().getName() + "' does not support 'getRole()'.");
			}
