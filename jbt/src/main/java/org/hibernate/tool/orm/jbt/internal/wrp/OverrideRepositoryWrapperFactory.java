...
public class OverrideRepositoryWrapperFactory {
	...
	public static OverrideRepositoryWrapper createOverrideRepositoryWrapper() {
		return new OverrideRepositoryWrapperImpl(new OverrideRepository());
	}
	...
	public static class OverrideRepositoryWrapperImpl implements OverrideRepositoryWrapper {
		...
		OverrideRepositoryWrapperImpl(OverrideRepository overrideRepository) {
		...
		public RevengStrategyWrapper getReverseEngineeringStrategy(RevengStrategyWrapper res) {
			return RevengStrategyWrapperFactory.createRevengStrategyWrapper(
					overrideRepository.getReverseEngineeringStrategy(
							(RevengStrategy) res.getWrappedObject()));
		}
